...
## Экраны (черновые эскизы)

Список поездок - создание и присоединение:

```
+--------------------------------------------------+
| TripSplit           Пользователь: Аня   [Выйти]  |
+--------------------------------------------------+
| Мои поездки:                                      |
|  * Поездка в Казань      [активна]    [Открыть]   |
|  * Выезд на природу      [завершена]  [Открыть]   |
+--------------------------------------------------+
| Создать поездку:       Присоединиться к поездке:  |
|  Название: [________]   ID поездки: [___________] |
|  Валюта:   [RUB___]     [Присоединиться]          |
|  [Создать]                                         |
+--------------------------------------------------+
```
...
```
+--------------------------------------------------+
| Поездка: Казань (активна)     Траты | Чеки | Итог |
+--------------------------------------------------+
| Новая трата                                       |
|  Название:   [Ужин в кафе_______]                 |
|  Тип:        [food v]                              |
|  Сумма:      [1200]    Скидка: [0]                 |
|  Заплатил:   [Аня v]                                |
|  Потребители:[x]Аня [x]Боря [ ]Вика                 |
|  Чек:  (o) без чека  ( ) существующий  ( ) новый    |
|  [Добавить трату]                                   |
+--------------------------------------------------+
```
...
```
+--------------------------------------------------+
| Поездка: Казань (завершена)                        |
+--------------------------------------------------+
| Общая сумма: 4500 RUB                              |
| Траты по участникам:                               |
|   Аня - 3000      Боря - 1500      Вика - 0        |
+--------------------------------------------------+
| Переводы:                                          |
|   Вика -> Аня : 1500                                |
|   Боря -> Аня : 500                                 |
